...
DEBUG = True
SECRET_KEY = os.getenv('SECRET_KEY', '8dgts#kd-6ge=ipv9)ke6n0uo_fjty8-awbu$zv3yvn(o7ey^(')
...
#else:
    # fallback SQLiteDATABASES = {'default': {'ENGINE': 'django.db.backends.sqlite3','NAME': BASE_DIR / 'db.sqlite3',}}
